...
public class TimeCounterForExp3 {
	...
	public static void main(String args[]) throws IOException{
        ...
        long[] timeForupDating = new long[totalPeerNum];
        ...
        for (int i = 1; i < totalPeerNum; i++){
			...
			FileReader file = new FileReader("log/timer/update" + schemaNames[i] + ".log");
...
//	        System.out.println("splitstring length: " + splitStrings.length);
	        ...
	        endTime[i] = eTime;
	        timeForupDating[i] = eTime - sTime;
	        avgUpdateT += timeForupDating[i];
	        fileInput.close();
		}
        
        avgUpdateT /= (totalPeerNum - 1);
        
        System.out.println("the average updating time of a mediated schema is " + avgUpdateT);
...
//			System.out.println("node " + i + ":" + endTime[i]);
		...
		////local computing for A
		
		FileReader file2 = new FileReader("log/timer/lc" + schemaNames[0] + ".log");
		BufferedReader fileInput2 = new BufferedReader(file2);
		String line2 = fileInput2.readLine();

        String splitStrings2[] = line2.split(" ");
        long sTime2 = Long.parseLong(splitStrings2[2]);
    	long eTime2 = Long.parseLong(splitStrings2[4]);
    	long timeForComputing = eTime2 - sTime2;
    	System.out.println("Peer 0 spent time in local MS computation 	" + timeForComputing);
    	fileInput2.close();
		///////
...
//	        System.out.println("splitstring length: " + splitStrings.length);
	        ...
	        System.out.println("Peer " + i + " spent time in local updating (updateNum|querycTime|avg) 	" 
